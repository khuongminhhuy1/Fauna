<template lang="">
  <div class="font-[sans-serif] bg-[url('/images/hero-image.png')] bg-cover">
      ...
      >
        <div class="md:max-w-md w-full px-4 py-4">
          <form @submit.prevent="login()">
            <div class="mb-12">
              <h3 class="text-gray-800 text-3xl font-extrabold uppercase">sign in</h3>
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
              ...
              <div>
                <a
                  ...
                  class="text-lime-600 font-semibold text-sm hover:underline"
                >
                  Forgot Password?
                </a>
              </div>
        ...
        <div
          class="md:h-full bg-[url('/images/ceres-fauna-dancing.gif')] bg-cover rounded-xl lg:p-12 p-8 text-right"
        ></div>
      </div>
    </div>
  </div>
