  ...
  <div class="font-[sans-serif] bg-[url('/images/hero-image.png')] bg-cover">
    <div class="min-h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <div
          class="md:h-full bg-[url('/images/gamble.gif')] bg-cover rounded-xl lg:p-12 p-8 text-right"
        ></div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    async register() {
      ...
      try {
        const response = await register(this.name, this.email, this.password, this.router)
